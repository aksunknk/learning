...
RUN pip install -r requirements.txt`,
  ...
  react: [
    ...
    },
    {
      ...
      mode: "answers",
      caseInsensitive: true,
      template: `Web の p / span  →  RN の ___`,
      answers: ["Text"],
    },
    {
      id: "react-fb-expo-start",
      title: "Expo 開発サーバ",
      hint: "よく使う開始コマンドのサブコマンド",
      lang: "Shell",
      mode: "answers",
      caseInsensitive: true,
      template: `$ npx expo ___`,
      answers: ["start"],
    },
    {
      id: "react-fb-stylesheet",
      title: "スタイルの置き場",
      hint: "オブジェクトスタイルをまとめる API",
      lang: "React Native",
      mode: "answers",
      caseInsensitive: true,
      template: `const styles = ___.create({ row: { flex: 1 } });`,
      answers: ["StyleSheet"],
    },
  ],
};
