...
const TABS = {
  ...
  webapi:        { label: "Web/API",          short: "API",    icon: "🌐", group: "backend",  lessons: 15, accent: "var(--webapi-green)",    glow: "rgba(0,191,165,0.35)" },
  ...
  reactarch:     { label: "CFG / UI防衛",     short: "CFG",    icon: "⛨", group: "frontend", lessons: 4,  accent: "#39ff14",                glow: "rgba(57,255,20,0.35)" },
  serverstate:   { label: "サーバ状態 / Query", short: "Query", icon: "⟳", group: "frontend", lessons: 4,  accent: "#22d3ee",                glow: "rgba(34,211,238,0.35)" },
  authclient:    { label: "認証 / キャッシュ", short: "Auth",  icon: "🔑", group: "frontend", lessons: 4,  accent: "#f59e0b",                glow: "rgba(245,158,11,0.35)" },
